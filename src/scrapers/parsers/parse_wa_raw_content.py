#!/usr/bin/env python3
"""
Parse Washington raw HTML content into structured JSON.
Based on proven New Jersey parser.
"""
import json
import re
...
def extract_plan_data(raw_content):
    ...
    org_match = re.search(r'Aetna Medicare|Humana|UnitedHealthcare|Wellcare|Blue Cross Blue Shield|BCBS|Devoted Health|Cigna|CareSource|Health Net|Kaiser Permanente|Clover|Emblem|Oxford|Highmark|Regence|PacificSource|Premera', raw_content, re.IGNORECASE)
    if org_match:
